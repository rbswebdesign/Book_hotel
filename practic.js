...
function sty(i) {
    var box = document.getElementsByClassName(i)[0]; // Use getElementsByClassName and select the first element
    box.style.clipPath = "inset(0% 0% 0% 0%)";
}
function cls(j)
{
    var abt=document.getElementsByClassName(j)[0];
    abt.style.clipPath="inset(99.9% 0% 0% 0%)";
}
